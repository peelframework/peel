...
import eu.stratosphere.peel.core.config.RichConfig
import eu.stratosphere.peel.core.results.model._
...
object DB {
  ...
  val logger: Logger = LoggerFactory.getLogger("eu.stratosphere.peel.core.db")
