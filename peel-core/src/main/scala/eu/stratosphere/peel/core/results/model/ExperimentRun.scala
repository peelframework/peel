...
/** Model class for experiment runs.
  *
  * Captures information for a single [[eu.stratosphere.peel.core.beans.experiment.Experiment.Run Experiment.Run]].
  *
  * @param experimentID The ID of the parent [[eu.stratosphere.peel.core.results.model.Experiment Experiment]].
