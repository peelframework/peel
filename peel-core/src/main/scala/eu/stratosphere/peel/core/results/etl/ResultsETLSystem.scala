...
import eu.stratosphere.peel.core.results.etl.EventExtractorManager.ProcessFile
import org.springframework.context.ApplicationContext

/** A system for [[eu.stratosphere.peel.core.results.model.ExperimentEvent ExperimentEvent]] extraction. */
