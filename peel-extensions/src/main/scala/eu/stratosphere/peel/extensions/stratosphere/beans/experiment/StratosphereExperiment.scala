package eu.stratosphere.peel.extensions.stratosphere.beans.experiment
...
import eu.stratosphere.peel.extensions.flink.beans.experiment
import eu.stratosphere.peel.extensions.stratosphere.beans.experiment
...
object StratosphereExperiment {
  ...
  class SingleJobRun(val id: Int, val exp: StratosphereExperiment, val force: Boolean) extends Experiment.SingleJobRun[Stratosphere, State] {
    ...
    import eu.stratosphere.peel.extensions.stratosphere.beans.experiment.StratosphereExperiment.StateProtocol._
