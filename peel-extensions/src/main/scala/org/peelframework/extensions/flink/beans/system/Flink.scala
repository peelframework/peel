package org.peelframework.extensions.flink.beans.system
...
/** Wrapper for Flink
  *
  * Implements Flink as a [[org.peelframework.core.beans.system.System System]] class and provides setup and teardown methods.
  *
