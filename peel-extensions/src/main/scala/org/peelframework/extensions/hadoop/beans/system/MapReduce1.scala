package org.peelframework.extensions.hadoop.beans.system
...
/** Wrapper for Hadoop Mapreduce 1
  *
  * Implements Hadoop Mapreduce as a [[org.peelframework.core.beans.system.System System]] class and provides setup and teardown methods.
  *
