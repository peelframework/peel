package org.peelframework.extensions.spark.beans.experiment
...
import org.peelframework.extensions.spark.beans.system.Spark
import org.peelframework.extensions.spark.beans.system.Spark
import spray.json._
...
object SparkExperiment {
  ...
  class SingleJobRun(val id: Int, val exp: SparkExperiment, val force: Boolean) extends Experiment.SingleJobRun[Spark, State] {
    ...
    import org.peelframework.extensions.spark.beans.experiment.SparkExperiment.StateProtocol._
