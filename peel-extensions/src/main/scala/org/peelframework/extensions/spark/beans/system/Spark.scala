package org.peelframework.extensions.spark.beans.system
...
/** Wrapper Class for Spark
  *
  * Implements Spark as a [[org.peelframework.core.beans.system.System System]] class and provides setup and teardown methods.
  *
  *
...
class Spark(version: String, lifespan: Lifespan, dependencies: Set[System] = Set(), mc: Mustache.Compiler) extends System("spark", version, lifespan, dependencies, mc) {
   ...
   *
   * @return [[org.peelframework.core.config.SystemConfig]] for the configured system
   */
