...
object FlinkEventsTest {
  ...
  val task01Events = Seq(
    "07/29/2015 19:55:14\tCHAIN DataSource (at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:18) (org.apache.flink.api.java.io.TextInputFormat)) -> FlatMap (FlatMap at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:19)) -> Map (Map at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:20)) -> Combine(SUM(1))(1/40) switched to SCHEDULED ",
    "07/29/2015 19:55:14\tCHAIN DataSource (at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:18) (org.apache.flink.api.java.io.TextInputFormat)) -> FlatMap (FlatMap at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:19)) -> Map (Map at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:20)) -> Combine(SUM(1))(2/40) switched to DEPLOYING ",
    "07/29/2015 19:55:15\tCHAIN DataSource (at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:18) (org.apache.flink.api.java.io.TextInputFormat)) -> FlatMap (FlatMap at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:19)) -> Map (Map at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:20)) -> Combine(SUM(1))(17/40) switched to RUNNING ",
    "07/29/2015 19:55:17\tCHAIN DataSource (at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:18) (org.apache.flink.api.java.io.TextInputFormat)) -> FlatMap (FlatMap at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:19)) -> Map (Map at eu.stratosphere.peel.flink.Wordcount$.main(Wordcount.scala:20)) -> Combine(SUM(1))(39/40) switched to FINISHED "
  )
